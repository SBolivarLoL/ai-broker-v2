...
export const STORED_OUTPUT_CATEGORIES: StoredOutputCategory[] = [
  ...
  { id: "research_runs", tables: ["research_runs"], contents: ["model output", "research metrics", "provider evidence and limitations"], sourceIds: ["alpaca_equity_iex", "alpaca_news_benzinga", "gdelt_doc_2", "finnhub_free_enrichment", "openfigi_v3", "sec_edgar", "treasury_fiscal_data", "bls_public_data", "fred_api", "bea_data_api", "openai_api", "local_derived_analytics"], retentionDecision: "until_manual_deletion", redistributionDecision: "internal_only", liveUseDecision: "paper_only" },
  ...
  { id: "strategy_experiments", tables: ["strategy_backtests", "strategy_runs", "strategy_data_snapshots", "strategy_decisions", "strategy_orders", "strategy_metrics", "strategy_notes", "strategy_audit_log"], contents: ["immutable backtests and provenance", "strategy configuration", "market snapshots", "decisions", "paper orders", "metrics", "notes", "hash-chained audit"], sourceIds: ["alpaca_paper_trading", "alpaca_crypto_data", "local_derived_analytics"], retentionDecision: "retention_metadata_without_automatic_purge", redistributionDecision: "internal_only", liveUseDecision: "paper_only" },
];
