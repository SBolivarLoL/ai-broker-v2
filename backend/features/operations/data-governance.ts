...
export const STORED_OUTPUT_CATEGORIES: StoredOutputCategory[] = [
  ...
  { id: "research_runs", tables: ["research_runs"], contents: ["model output", "research metrics", "provider evidence and limitations", "point-in-time comparable valuation reports with canonical replay hashes"], sourceIds: ["alpaca_equity_iex", "alpaca_news_benzinga", "gdelt_doc_2", "finnhub_free_enrichment", "openfigi_v3", "sec_edgar", "treasury_fiscal_data", "bls_public_data", "fred_api", "bea_data_api", "openai_api", "local_derived_analytics"], retentionDecision: "until_manual_deletion", redistributionDecision: "internal_only", liveUseDecision: "paper_only" },
