...
| Research data         | SEC, Alpaca/IEX, Treasury, BLS, optional FRED/BEA/Finnhub, GDELT, OpenFIGI, and optional OpenAI                                                                                                         | The registry covers 16 sources and all 23 SQLite tables through 12 output categories; provider health, strategy dataset quality, canonical evidence time provenance, and migrated company-market/market-workspace/multi-asset DTO time provenance are visible from local evidence, while full DTO migration, retention enforcement, and external entitlement review remain open |
