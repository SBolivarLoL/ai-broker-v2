...
| Strategy research     | Nine deterministic plugins, immutable linked backtests, versioned long-history crypto bars, shadow/paper runs, traces and attribution                                                                  | Exact code/data lineage is enforced for comparable records; genuine out-of-sample evaluation remains open                                                               |
