...
Last reviewed against `main` commit `3110cbb`: 2026-07-12.
...
7. [ ] Add a visible data-coverage panel for each research report, portfolio calculation, and strategy run: expected inputs, received inputs, omitted inputs, freshness, and impact on conclusions. Portfolio optimizer and portfolio scenario responses plus their status lines now expose this contract; the remaining workspaces still need equivalent visible detail.
