...
| Strategy research     | Nine deterministic plugins, immutable linked backtests, versioned long-history crypto bars, rolling train-only walk-forward evaluation, shadow/paper runs, traces and attribution                      | Exact lineage and per-fold leakage checks are enforced; final holdouts, uncertainty, richer metrics, and long paper evidence remain open                                  |
