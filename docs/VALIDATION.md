...
| ------------------ | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| `bun run check`    | Pass: 362 tests, 0 failures, 1,703 assertions across 83 files                     | Strict TypeScript for `backend/`, `tests/`, and `scripts/`, all Bun tests, and the coverage floor |
...
| `bun run coverage` | Pass: 98.10% functions, 97.16% lines against 95% function and 96% line thresholds | Mean coverage across imported deterministic TypeScript modules                                    |
...
| TypeScript    | 94 production modules and 82 files under `tests/` plus one coverage-gate test                                                      |
| Concentration | `backend/app.ts` 343 lines; `backend/persistence/store.ts` 906 lines; browser behavior split across nine shell/style/script assets |
...
| Git baseline  | `main`, `dev`, `origin/main`, and `origin/dev` at `4e12cb8`; no open pull request at change start                                  |
...
- Fresh inventory checks found 94 production TypeScript modules, 82 files under
...
- The broker account/order, watchlist/workspace, asset-search, company-child,
  portfolio-performance, and portfolio-risk time-provenance changes were
