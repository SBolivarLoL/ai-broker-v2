...
- Canonical evidence, crypto Strategy Lab market DTOs, single-symbol quote responses, market monitoring DTOs, company-market snapshots, market workspace root/watchlist/asset/discovery/calendar DTOs, option-chain and option-portfolio Greek DTOs, equity quote/bar stream DTOs, and the multi-asset market DTO distinguish provider observation/publication/effective time from retrieval and server response time; official macro evidence also records effective periods for record dates, months, quarters, and market-session calendars.
