...
export const STORED_OUTPUT_CATEGORIES: StoredOutputCategory[] = [
  ...
  { id: "strategy_experiments", tables: ["strategy_runs", "strategy_data_snapshots", "strategy_decisions", "strategy_orders", "strategy_metrics", "strategy_notes", "strategy_audit_log"], contents: ["strategy configuration", "market snapshots", "decisions", "paper orders", "metrics", "notes", "hash-chained audit"], sourceIds: ["alpaca_paper_trading", "alpaca_crypto_data", "local_derived_analytics"], retentionDecision: "retention_metadata_without_automatic_purge", redistributionDecision: "internal_only", liveUseDecision: "paper_only" },
];
