...
test("creates strategy error counter metric", () => {
  expect(buildStrategyErrorMetric("run-1", "2026-06-24T10:00:00.000Z")).toEqual({ runId: "run-1", name: "strategy_error_count", value: 1, unit: "count", asOf: "2026-06-24T10:00:00.000Z" });
});
