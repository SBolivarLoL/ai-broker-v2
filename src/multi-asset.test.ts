...
test("normalizes entitled multi-asset data and explicit coverage warnings", () => {
  const dto = multiAssetDto({
    ...
    forex: { "EUR/USD": { bp: 1.1, ap: 1.1002, mp: 1.1001, t: "2026-06-22T20:00:00Z" } },
    crypto: { "BTC/USD": { latestQuote: { bp: 99, ap: 101, t: "2026-06-22T20:00:00Z" }, dailyBar: { c: 105, h: 110, l: 90, v: 12 }, prevDailyBar: { c: 100 } } },
