...
Code baseline reviewed: `main` at `499afa8` on 2026-07-12.
...
The creation route accepts one subject, one to four distinct peers, and a real,
non-future `YYYY-MM-DD` cutoff. Replay reads the stored canonical artifact and
does not call Alpaca or SEC again.
