...
Code baseline reviewed: `main` at `4da4baa` on 2026-07-07.
...
- Alpaca paper account, positions, orders, activities, watchlists, market clock, calendar, IEX market data, market workspace discovery/session DTOs, and entitled multi-asset market snapshots with explicit observation/retrieval provenance where migrated.
