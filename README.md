...
Code baseline reviewed: `main` at `54a16dc` on 2026-07-07.
...
- Alpaca paper account, positions, orders, activities, watchlists, market clock, calendar, IEX market data, and entitled multi-asset market snapshots with explicit observation/retrieval provenance on normalized market DTOs where migrated.
