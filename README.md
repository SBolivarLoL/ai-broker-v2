...
Code baseline reviewed: `main` at `a3d5e65` on 2026-07-07.
...
- Immutable crypto backtests linked to shadow and scheduled runs, versioned long-history bar datasets, train-only rolling/anchored walk-forward evaluation with untouched holdouts and regime slices, bounded approved paper experiments, exact dataset/code provenance, trace reconstruction, alerts, attribution, and reports.
