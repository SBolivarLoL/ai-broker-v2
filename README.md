...
Code baseline reviewed: `main` at `2ea494a` on 2026-07-07.
...
- SEC filings and company facts, official US macro context, Alpaca/Benzinga news, GDELT signals, optional Finnhub enrichment, and OpenFIGI identity checks with canonical source/time provenance; GDELT media-signal DTOs preserve publication, retrieval, and server-response time.
